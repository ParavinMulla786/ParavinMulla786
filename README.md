...
[![GitHub](https://img.shields.io/badge/GitHub-Follow-black?style=flat-square\&logo=github)](https://github.com/ParavinMulla786)
...
* Developed full-stack modules using **Spring Boot and React**
* Designed secure **REST APIs with Role-Based Access Control (RBAC)**
* Improved backend performance by optimizing **database queries**
* Worked in **Agile development environment**
* Delivered well-tested **production-ready features**

---

## 🌐 Full Stack Developer Intern

**Developer.dev Pvt. Ltd. | Summer 2025**

* Built scalable applications using **MEAN Stack and MySQL**
* Developed and documented **Spring Boot REST APIs**
* Designed responsive **frontend user interfaces**
* Participated in full **Software Development Life Cycle (SDLC)**
* Collaborated with teams for **timely delivery of projects**
...
**Tech:** Next.js • React • Gemini AI • PostgreSQL

* Built AI-powered mock interview platform
* Integrated AI for **answer evaluation and feedback**
...
* Developed multi-role system (**Admin, User, Agent**)
* Implemented **real-time waste pickup request tracking**
* Created **analytics dashboard**
* Secured backend using **JWT authentication**
...
![3D Contribution Graph](https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=ParavinMulla786\&theme=tokyonight)
